# Generated by Django 4.2.8 on 2024-03-01 16:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Discount', 'Скидка'), ('Bonus', 'Бонус'), ('Certificate', 'Сертификат'), ('Розыгрыш', 'Розыгрыш')], default='Discount', max_length=45)),
                ('work_time', models.CharField(max_length=100, null=True)),
                ('end_date', models.DateField()),
                ('is_daily', models.BooleanField(default=False)),
                ('address', models.ManyToManyField(related_name='promotions_address', to='promotion.promotionaddress')),
                ...
                ('contacts', models.ManyToManyField(blank=True, null=True, related_name='promotion_contacts', to='promotion.contact', verbose_name='Контакты акций')),
                ('likes', models.ManyToManyField(blank=True, null=True, related_name='liked_promotions', to=settings.AUTH_USER_MODEL)),
            ],
            options={
